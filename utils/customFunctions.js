  ...
  services.forEach(service => {
    ...
    for (const employee of employeeData) {
      ...
      const providesService = employee.employeeServices.some(empService =>
        empService && empService.service ? empService.service.id === service.serviceId : false
      );
      console.log("ðŸš€ ~providesService:",service.serviceId, providesService,"Employee",employee.id)
